  ...
  methods: {
    upload(e) {
      ...
      files.forEach((file) => {
        ...
        const storageRef = storage.ref(); // music-player-366ae.appspot.com
        const songsRef = storageRef.child(`songs/${file.name}`); // music-player-366ae.appspot.com/songs/example.mp3
